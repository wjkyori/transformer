...
import org.transformer.support.dao.jpa.search.SearchableDefaults;
...
public class SearchableMethodArgumentResolver extends BaseMethodArgumentResolver {
  ...
  private static final PageableMethodArgumentResolver DPR = new PageableMethodArgumentResolver();
  ...
  /** 分页参数解析器. */
  private PageableMethodArgumentResolver pageableMethodArgumentResolver = DPR;
  ...
  private static String[] filterSearchValues(String[] values) {
   ...
   */
  private static SearchableDefaults getSearchableDefaults(MethodParameter parameter) {
    // 首先从参数上找
   ...
   */
  private static Searchable getDefaultFromAnnotation(SearchableDefaults searchableDefaults) {
   ...
   */
  private static Searchable defaultSearchable(SearchableDefaults searchableDefaults) {
